...
int newState_y_displ(fuzzyLogic_y_displ * fl) {
	...
	flag = createOutput_y_displ(&(fo[0]), "right_beta_angle", MF_right_beta_angle, 3);
	if (flag < 0) {
		return 1;
	}
	...
	flag = createOutput_y_displ(&(fo[1]), "left_beta_angle", MF_left_beta_angle, 3);
	if (flag < 0) {
		return 1;
	}
	...
	strcpy(rules[0].thenRules[0].name, "right_beta_angle");
	strcpy(rules[0].thenRules[0].mf, "neg");
	strcpy(rules[0].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[1].thenRules[0].name, "right_beta_angle");
	strcpy(rules[1].thenRules[0].mf, "zero");
	strcpy(rules[1].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[2].thenRules[0].name, "right_beta_angle");
	strcpy(rules[2].thenRules[0].mf, "zero");
	strcpy(rules[2].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[3].thenRules[0].name, "right_beta_angle");
	strcpy(rules[3].thenRules[0].mf, "zero");
	strcpy(rules[3].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[4].thenRules[0].name, "right_beta_angle");
	strcpy(rules[4].thenRules[0].mf, "zero");
	strcpy(rules[4].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[5].thenRules[0].name, "right_beta_angle");
	strcpy(rules[5].thenRules[0].mf, "zero");
	strcpy(rules[5].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[6].thenRules[0].name, "right_beta_angle");
	strcpy(rules[6].thenRules[0].mf, "zero");
	strcpy(rules[6].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[7].thenRules[0].name, "right_beta_angle");
	strcpy(rules[7].thenRules[0].mf, "zero");
	strcpy(rules[7].thenRules[1].name, "left_beta_angle");
	...
	strcpy(rules[8].thenRules[0].name, "right_beta_angle");
	strcpy(rules[8].thenRules[0].mf, "pos");
	strcpy(rules[8].thenRules[1].name, "left_beta_angle");
