...
int newState_y_displ(fuzzyLogic_y_displ * fl) {
	...
	// Input variable: y_diff
	// Difference between the actual and desired y value
	memFunction_y_displ MF_y_diff[3];

	double poi_y_diff_neg[] = { -0.5, -0.5, 0.0 };
	createMemFunction_y_displ(&(MF_y_diff[0]), "neg", TRI_MF, poi_y_diff_neg);
	double poi_y_diff_zero[] = { -0.5, 0.0, 0.5 };
	createMemFunction_y_displ(&(MF_y_diff[1]), "zero", TRI_MF, poi_y_diff_zero);
	double poi_y_diff_pos[] = { 0.0, 0.5, 0.5 };
	createMemFunction_y_displ(&(MF_y_diff[2]), "pos", TRI_MF, poi_y_diff_pos);

	flag = createInput_y_displ(&(fi[0]), "y_diff", MF_y_diff, 3, -0.5, 0.5);
	if (flag < 0) {
		return 1;
	}
	...
	strcpy(rules[0].ifRules[0].name, "y_diff");
	...
	strcpy(rules[1].ifRules[0].name, "y_diff");
	...
	strcpy(rules[2].ifRules[0].name, "y_diff");
	...
	strcpy(rules[3].ifRules[0].name, "y_diff");
	...
	strcpy(rules[4].ifRules[0].name, "y_diff");
	...
	strcpy(rules[5].ifRules[0].name, "y_diff");
	...
	strcpy(rules[6].ifRules[0].name, "y_diff");
	...
	strcpy(rules[7].ifRules[0].name, "y_diff");
	...
	strcpy(rules[8].ifRules[0].name, "y_diff");
