...
int newState_x_displ(fuzzyLogic_x_displ * fl) {
	...
	double poi_front_beta_angle_neg[] = { -1.0, -1.0, 0.0 };
	createMemFunction_x_displ(&(MF_front_beta_angle[0]), "neg", TRI_MF, poi_front_beta_angle_neg);
	double poi_front_beta_angle_zero[] = { -1.0, 0.0, 1.0 };
	createMemFunction_x_displ(&(MF_front_beta_angle[1]), "zero", TRI_MF, poi_front_beta_angle_zero);
	double poi_front_beta_angle_pos[] = { 0.0, 1.0, 1.0 };
	createMemFunction_x_displ(&(MF_front_beta_angle[2]), "pos", TRI_MF, poi_front_beta_angle_pos);
	...
	double poi_rear_beta_angle_neg[] = { -1.0, -1.0, 0.0 };
	createMemFunction_x_displ(&(MF_rear_beta_angle[0]), "neg", TRI_MF, poi_rear_beta_angle_neg);
	double poi_rear_beta_angle_zero[] = { -1.0, 0.0, 1.0 };
	createMemFunction_x_displ(&(MF_rear_beta_angle[1]), "zero", TRI_MF, poi_rear_beta_angle_zero);
	double poi_rear_beta_angle_pos[] = { 0.0, 1.0, 1.0 };
	createMemFunction_x_displ(&(MF_rear_beta_angle[2]), "pos", TRI_MF, poi_rear_beta_angle_pos);
	...
	createMemFunction_x_displ(&(MF_left_alpha_angle[0]), "neg", TRI_MF, poi_left_alpha_angle_neg);
	double poi_left_alpha_angle_zero[] = { -1.0, 0.0, 1.0 };
	createMemFunction_x_displ(&(MF_left_alpha_angle[1]), "zero", TRI_MF, poi_left_alpha_angle_zero);
	double poi_left_alpha_angle_pos[] = { 0.0, 1.0, 1.0 };
	createMemFunction_x_displ(&(MF_left_alpha_angle[2]), "pos", TRI_MF, poi_left_alpha_angle_pos);
	...
	createMemFunction_x_displ(&(MF_right_alpha_angle[0]), "neg", TRI_MF, poi_right_alpha_angle_neg);
	double poi_right_alpha_angle_zero[] = { -1.0, 0.0, 1.0 };
	createMemFunction_x_displ(&(MF_right_alpha_angle[1]), "zero", TRI_MF, poi_right_alpha_angle_zero);
	double poi_right_alpha_angle_pos[] = { 0.0, 1.0, 1.0 };
	createMemFunction_x_displ(&(MF_right_alpha_angle[2]), "pos", TRI_MF, poi_right_alpha_angle_pos);
